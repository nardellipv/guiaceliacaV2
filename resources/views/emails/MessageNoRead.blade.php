    ...
    <tbody>
        ...
        <tr style="height: 161px;">
            <td style="width: 596px; height: 161px;">
                <p style="text-align: center;">Estas recibiendo este email porque tienes mensajes no leídos de tus
                    clientes.</p>
                <p style="text-align: center;">Ingresa a tu panel de control, en el áre de mensajes podras leer y
                    responder
                    todos.</p>
                <p style="text-align: center;">&nbsp;</p>
                <p style="text-align: center;">Te recomendamos que respondas los mensajes de los usuarios del sitio lo
                    antes
                    posible. Puede que ganes nuevos clientes y te recomienden.</p>
                <hr />
            </td>
        </tr>
