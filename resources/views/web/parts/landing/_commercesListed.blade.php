                            ...
                            <div class="row">
                                <div class="masonry">
                                    @foreach ($commercesListed as $commerceList)
                                        <div
                                            class="col-md-6 col-sm-6 col-lg-6 filter-item filter-item{{ $commerceList->province->id }}">
                                            <div class="featured-restaurant-box style2 brd-rd12 wow fadeIn"
                                                ...
                                                <div class="featured-restaurant-info">
                                                    ...
                                                    <h4 itemprop="headline"><a
                                                            ...
                                                            title="" itemprop="url">{{ $commerceList->name }}</a></h4>
                                                    <span class="food-types">Sobre nosotros:
                                                        <em
                                                            class="yellow-clr">{{ Str::limit($commerceList->about, 100) }}</em>
                                                    </span>
                                                    {{--<ul class="post-meta">
                                                    ...
                                                    <span class="post-likes style2 red-clr"><i
                                                        ...
                                                        {{ $commerceList->votes_positive }}</span>
                                                    <a class="brd-rd5"
                                                        href="{{ route('name.commerce', $commerceList->slug) }}"
