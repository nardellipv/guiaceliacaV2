                        ...
                        <table class="table-striped table-hover">
                            ...
                            @foreach($products as $product)
                                <tr>
                                    ...
                                    <td><a href="{{ route('product.activeAction', $product) }}"><i class="icon fa fa-play"></i></a></td>
                                    <td><a href="{{ route('product.deleteAction', $product) }}"><i class="icon fa fa-trash"></i></a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
