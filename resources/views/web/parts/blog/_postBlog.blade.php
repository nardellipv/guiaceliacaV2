                            ...
                            <div class="col-md-9 col-sm-12 col-lg-9">
                                <div class="blog-detail-wrapper">
                                    <div class="blog-detail-thumb wow fadeIn" data-wow-delay="0.2s">
                                        <img src="{{ asset('blog/images/787x255-' .$post->photo) }}" alt="{{ $post->title }}" itemprop="image">
                                    </div>
                                    <div class="blog-detail-info">
                                        <span class="post-detail-date red-clr"><i class="fa fa-clock-o"></i> {{ $post->created_at->format('d') }}
